          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-white/20 rounded-lg px-4 py-3 text-black placeholder-black font-semibold
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white border border-white/20 rounded-lg px-4 py-3 text-black placeholder-black font-semibold resize-none
                           focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition"
              />
            </div>
